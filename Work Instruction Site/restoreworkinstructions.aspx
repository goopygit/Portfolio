...
<head>
    ...
    <title>Restore Work Instructions</title>
</head>

<body>
    <h1>Restore Work Instructions</h1>
    ...
    <div class="rightSection" id="overview">
        <p1>
            ...
            <br> If you have a backup SD card in the box, compare the last 3 digits of the serial number to what was written in the backup section. Any mismatch should be processed as a discrepancy and brought to the immediate attention of a supervisor
            or team lead.
        </p1>
    </div>
    ...
    <div class="rightSection" id="Unrecoverable">
        <p1>
            ...
            <br> The next few steps are skipped, and you are prompted to enter the nickname. To get the Nickname, power on the unit with no test card present, so that you boot into the typical system menu. From the main menu, select the user profile in
            the upper left of the screen. They may have more than one user, but we are primarily concerned with the left-most profile. Enter the Nickname exactly as it is shown on the unit, but exclude "'s Profile'". If a character in the nickname cannot
            be entered on the keyboard, such as a star symbol, enter a '?' in place of the character.
    ...
    <div class="rightSection" id="Restore Process">
        <p1>
            ...
            <br>You are prompted to enter the nickname. To get the Nickname, power on the unit with no test card present, so that you boot into the typical system menu. From the main menu, select the user profile in the upper left of the screen. They may have
    ...
    <div class="rightSection" id="PIT">
        <p1>
            ...
            &#9657; For the following steps, you will need to use <a href="https://pit.mng.nintendo.net/pit/">PIT.</a> A lead or supervisor will log you into PIT.</a>
            <br> Note that you must also obtain the source serial number from the Restore form in Galaxy before you are able to perform these steps.
            <br> &#9657; <a href="https://nintendo.sharepoint.com/:w:/r/sites/techsvc/NX/_layouts/15/Doc.aspx?sourcedoc=%7BBDBEC164-6F74-4448-BF98-7F7F5BDDDE32%7D&file=PIT%E6%A9%9F%E5%99%A8%E8%AA%8D%E8%A8%BC%E5%85%A8%E5%89%8A%E9%99%A4%E6%96%B9%E6%B3%95_%E3%83%86%E3%83%B3%E3%83%97%E3%83%AC%E3%83%BC%E3%83%88%E6%A1%88.docx&action=default&mobileredirect=true"
                target="_blank">Follow the instructions here to perform the "Deactivate All" and "Email" steps. This guide covers both steps.</a>
            <br> &#9657; <a href="https://nintendo.sharepoint.com/sites/techsvc/NX/Shared%20Documents/HAC-62-0400-001.pdf#page=12" target="_blank">Follow the instructions here to perform the Animal Crossing Data Recovery step. </a> <b><u>This only applies to unrecoverable units.</u></b>
            <br>
            <div style="color:red"> <b>&#9657; Take care to look out for any devices which are banned. Any banned device must be handled as a discrepancy unless otherwise instructed by a supervisor.</b></div>
            &#9657; Banned devices are identified in PIT by a red banner which is displayed after clicking the Device ID. For more information on Banned Units, <a href="https://nintendo.sharepoint.com/sites/techsvc/NX/Pages/Referenced_Procedures.aspx#pre">Click Here.</a>
        </p1>
    </div>
    <div class="rightSection" id="conclusion">
        <p1>
            ...
            <br><a style="font-size:24px" href="https://forms.office.com/Pages/ResponsePage.aspx?id=BMMfJE49Gk2u9jMP4oQbL9Yi-lwxY79Ph1FSpfPz8TRUMTc3RU5GRTNPU1I3Sk1IUklaVFExVUtZMC4u">Click here to acknowledge receipt of training.</a>
        </p1>
    </div>
</body>
